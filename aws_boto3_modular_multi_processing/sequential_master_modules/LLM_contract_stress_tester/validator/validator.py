...
def validate_response(
    ...
    # Most of the validator semantics were insuffienct to keep up with the LLM intelligence and most of the validator is 
    # decomissioned. The semantics files below do not work with gpt-5.6-sol and so we need to disable them because they are forcing
    # fallback in the LLM response. 
