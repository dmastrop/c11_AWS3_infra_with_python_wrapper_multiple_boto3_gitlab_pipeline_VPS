...
GLOBAL_RULES = (
                ...
                "\n"
                "- If a rewrite, retry, or cleanup sequence would require introducing a new\n"
                "  system-wide operation, or modifying an existing system-wide operation, and\n"
                "  this is NOT part of an OS-signaled remediation flow, the LLM MUST return\n"
                "  \"fallback\" instead.\n"
                "\n"
                "- Preserving system-wide operations that already appear in the original\n"
                "  command, without changing their flags, arguments, or position, is allowed\n"
